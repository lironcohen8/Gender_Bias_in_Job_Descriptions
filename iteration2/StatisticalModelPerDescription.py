...
for index, row in df.iterrows():
    ...
    results_df = results_df.append({'description': description, 'skills_biased_phrases': skills_biased_phrases, 'skills_count': skills_count, 'work_env_biased_phrases': work_env_biased_phrases, 'work_env_count': work_env_count,'coding_lang_biased_phrases': coding_lang_biased_phrases,"coding_lang_count": coding_lang_count, 'education_biased_phrases': education_biased_phrases, 'education_count': education_count, 'nlp_biased_phrases': nlp_biased_phrases, 'nlp_count': nlp_count, 'total_count': total_count}, ignore_index=True)
